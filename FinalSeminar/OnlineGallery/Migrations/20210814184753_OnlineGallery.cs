...
{
    public partial class OnlineGallery : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fuel = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    Color = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    Mileage = table.Column<int>(type: "int", nullable: false),
                    Engine = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    Transmission = table.Column<string>(type: "nvarchar(50)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClosingDay = table.Column<DateTime>(type: "date", nullable: true),
                    StartingPrice = table.Column<int>(type: "int", nullable: false),
                    StepPrice = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MyFavorites", x => new { x.UserId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_MyFavorites_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MyFavorites_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuctionRecord", x => new { x.Id, x.AuctionId, x.UserId });
                    table.ForeignKey(
                        name: "FK_AuctionRecord_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuctionRecord_UserId",
                table: "AuctionRecord",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_MyFavorites_ProductId",
                table: "MyFavorites",
                column: "ProductId");
